...
class TrendingVC: BaseViewController , UICollectionViewDelegate ,UICollectionViewDataSource  , UICollectionViewDelegateFlowLayout {
    ...
    @IBOutlet var viewModel : TrendingViewModel!
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let gift_ = viewModel.getGift(indexPath: indexPath){
            cell . displayContent(gift : gift_)
        }
        return cell
    }
    ...
    func callApi()
    {
        ...
        self.viewModel.requestTrendingList(limit:self.limit, page : self.page ,completion: {
            success in
            if success == true {
                self.loadMore = true
                DispatchQueue.main.async {
